...
from modules import sd_samplers, deepbooru, sd_hijack, images, scripts, ui, errors, infotext_utils, sd_schedulers
...
class Api:
    def __init__(self, app: FastAPI, queue_lock: Lock):
        ...
        self.add_api_route("/api/v1/txt2img", self.text2imgapi, methods=["POST"], response_model=models.TextToImageResponse)
        self.add_api_route("/api/v1/interrupt", self.interruptapi, methods=["POST"])
        self.add_api_route("/api/v1/skip", self.skip, methods=["POST"])
        self.add_api_route("/api/v1/progress", self.progressapi, methods=["GET"], response_model=models.ProgressResponse)
        self.add_api_route("/api/v1/samplers", self.get_samplers, methods=["GET"], response_model=list[models.SamplerItem])
        self.add_api_route("/api/v1/schedulers", self.get_schedulers, methods=["GET"], response_model=list[models.SchedulerItem])
        self.add_api_route("/api/v1/upscalers", self.get_upscalers, methods=["GET"], response_model=list[models.UpscalerItem])
